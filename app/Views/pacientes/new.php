                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?php echo base_url()?>/paciente/create" autocomplete="off">
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="apellido_p" name="apellido_p"  type="text" placeholder="Ingrese apellido paterno " />
                                                        <label for="apellido_p">APellido Paterno</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="apellido_m"  name="apellido_m"  type="text" placeholder="Ingrese apellido materno " />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="direccion" type="direccion" placeholder="Ingrese su direccion" />
